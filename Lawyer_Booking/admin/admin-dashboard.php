...
<head>
  ...
  <meta name="description" content="Divorce management system">
  <meta name="author" content="MartDevelopers">

  <title>Split-Smart Divorce System - Admin Dashboard</title>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  //code for summing up number of lawyers
                  $result ="SELECT count(*) FROM tms_lawyer";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($lawyer);
                  $stmt->fetch();
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $lawyer;?></span> Laywers</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="admin-view-lawyer.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
