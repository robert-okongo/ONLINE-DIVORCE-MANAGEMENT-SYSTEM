<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Registered Laywers:</h6>
          <a class="dropdown-item" href="admin-add-lawyer.php">Add</a>
          <a class="dropdown-item" href="admin-view-lawyer.php">View</a>
          <a class="dropdown-item" href="admin-manage-lawyer.php">Manage</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="admin-view-messages.php">View</a>
        </div>
      </li>
