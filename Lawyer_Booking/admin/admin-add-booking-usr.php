      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">lawyer gender</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">lawyer Registration Number</label>
              <select class="form-control" name="u_car_regno" id="exampleFormControlSelect1">
                <?php

                $ret="SELECT * FROM tms_lawyer  "; //sql code to get to all lawyers
                $stmt= $mysqli->prepare($ret) ;
                $stmt->execute() ;//ok
                $res=$stmt->get_result();
                $cnt=1;
                ...
                {
                ?>
                <option><?php echo $row->l_reg_no;?></option>
                <?php }?> 
              </select>
            </div>
            ...
            <button type="submit" name="book_lawyer" class="btn btn-success">Confirm Booking</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
