          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Book lawyer</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="usr-book-lawyer.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                  ...
                  $ret="SELECT * FROM tms_lawyer "; //get all bookings
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $row->l_reg_no;?></td>
                    <td><?php echo $row->l_pass_no;?></td>
                    <td><?php echo $row->v_driver;?></td>
                    <td><?php if($row->l_status == "Available"){ echo '<span class = "badge badge-success">'.$row->l_status.'</span>'; } else { echo '<span class = "badge badge-danger">'.$row->l_status.'</span>';}?></td>
