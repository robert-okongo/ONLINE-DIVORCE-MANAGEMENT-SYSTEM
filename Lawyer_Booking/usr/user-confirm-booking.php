    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Book lawyer</li>
        ...
        ?>
          ...
          <div class="form-group">
                ...
                <input type="text" value="<?php echo $row->l_name;?>" readonly class="form-control" name="u_car_type">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">lawyer Registration Number</label>
                <input type="email" value="<?php echo $row->l_reg_no;?>" readonly class="form-control" name="u_car_regno">
            </div>
            <div class="form-group">
