        ...
        ?>
            <ul class="sidebar navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      <h6 class="dropdown-header">Available lawyers:</h6>
                      <a class="dropdown-item" href="usr-book-lawyer.php">Book</a>
                    </div>
                  </li>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      ...
                      <a class="dropdown-item" href="usr-book-lawyer.php">Add</a>
